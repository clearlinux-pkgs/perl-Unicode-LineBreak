...
cp %{_builddir}/Unicode-LineBreak-%{version}/sombok/COPYING %{buildroot}/usr/share/package-licenses/perl-Unicode-LineBreak/18eaf66587c5eea277721d5e569a6e3cd869f855 || :
if test -f Makefile.PL; then
